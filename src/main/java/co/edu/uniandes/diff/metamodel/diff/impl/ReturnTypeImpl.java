 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.diff.metamodel.diff.impl.ReturnTypeImpl#getOldDefinition <em>Old Definition</em>}</li>
 *   <li>{@link co.edu.uniandes.diff.metamodel.diff.impl.ReturnTypeImpl#getNewDefinition <em>New Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnTypeImpl extends ModifyImpl implements ReturnType {
	...
	public NotificationChain basicSetOldDefinition(ElementDefinition newOldDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, diffPackage.RETURN_TYPE__OLD_DEFINITION, oldOldDefinition, newOldDefinition);
	...
	public void setOldDefinition(ElementDefinition newOldDefinition) {
		if (newOldDefinition != oldDefinition) {
			...
			if (oldDefinition != null)
				msgs = ((InternalEObject)oldDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - diffPackage.RETURN_TYPE__OLD_DEFINITION, null, msgs);
			if (newOldDefinition != null)
				msgs = ((InternalEObject)newOldDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - diffPackage.RETURN_TYPE__OLD_DEFINITION, null, msgs);
			msgs = basicSetOldDefinition(newOldDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, diffPackage.RETURN_TYPE__OLD_DEFINITION, newOldDefinition, newOldDefinition));
	}
	...
	public NotificationChain basicSetNewDefinition(ElementDefinition newNewDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, diffPackage.RETURN_TYPE__NEW_DEFINITION, oldNewDefinition, newNewDefinition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNewDefinition(ElementDefinition newNewDefinition) {
		if (newNewDefinition != newDefinition) {
			...
			if (newDefinition != null)
				msgs = ((InternalEObject)newDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - diffPackage.RETURN_TYPE__NEW_DEFINITION, null, msgs);
			if (newNewDefinition != null)
				msgs = ((InternalEObject)newNewDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - diffPackage.RETURN_TYPE__NEW_DEFINITION, null, msgs);
			msgs = basicSetNewDefinition(newNewDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, diffPackage.RETURN_TYPE__NEW_DEFINITION, newNewDefinition, newNewDefinition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case diffPackage.RETURN_TYPE__OLD_DEFINITION:
				return basicSetOldDefinition(null, msgs);
			case diffPackage.RETURN_TYPE__NEW_DEFINITION:
