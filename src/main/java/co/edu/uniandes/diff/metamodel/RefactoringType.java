 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.diff.metamodel.RefactoringType#getChanges <em>Changes</em>}</li>
 * </ul>
 *
 * @see co.edu.uniandes.diff.metamodel.DiffPackage#getRefactoringType()
 * @model
 * @generated
 */
public interface RefactoringType extends EObject {
	 ...
	 * @see co.edu.uniandes.diff.metamodel.DiffPackage#getRefactoringType_Changes()
	 * @model
	 * @generated
	 */
