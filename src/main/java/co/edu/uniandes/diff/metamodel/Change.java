 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.diff.metamodel.Change#getChangeElement <em>Change Element</em>}</li>
 * </ul>
 *
 * @see co.edu.uniandes.diff.metamodel.DiffPackage#getChange()
 * @model
 * @generated
 */
public interface Change extends EObject {
	 ...
	 * The literals are from the enumeration {@link co.edu.uniandes.diff.metamodel.APIElementType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see co.edu.uniandes.diff.metamodel.DiffPackage#getChange_ChangeElement()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link co.edu.uniandes.diff.metamodel.Change#getChangeElement <em>Change Element</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
